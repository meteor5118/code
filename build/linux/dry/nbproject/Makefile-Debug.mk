...
${CND_DISTDIR}/../../dist/${CND_PLATFORM}/${CND_CONF}/dry: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/../../dist/${CND_PLATFORM}/${CND_CONF}/dry ${OBJECTFILES} ${LDLIBSOPTIONS} -ldl
...
${OBJECTDIR}/_ext/20fb0c70/parse_curl.o: ../../../src/dry/parse_cmd/parse_curl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_curl.o ../../../src/dry/parse_cmd/parse_curl.cpp

${OBJECTDIR}/_ext/20fb0c70/parse_rsync.o: ../../../src/dry/parse_cmd/parse_rsync.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/20fb0c70
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_rsync.o ../../../src/dry/parse_cmd/parse_rsync.cpp

${OBJECTDIR}/_ext/20fb0c70/parse_wget.o: ../../../src/dry/parse_cmd/parse_wget.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/20fb0c70
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_wget.o ../../../src/dry/parse_cmd/parse_wget.cpp

${OBJECTDIR}/_ext/9c7e2875/read_file.o: ../../../src/dry/toolbox/read_file.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/9c7e2875
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9c7e2875/read_file.o ../../../src/dry/toolbox/read_file.cpp

${OBJECTDIR}/_ext/7bd80be/gzip_file.o: ../../../src/lib/gzip/gzip_file.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/7bd80be
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7bd80be/gzip_file.o ../../../src/lib/gzip/gzip_file.cpp
...
${TESTDIR}/_ext/4a113312/gzip_file_runner.o: ../../../test/lib/gzip/gzip_file_runner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/4a113312/gzip_file_runner.o ../../../test/lib/gzip/gzip_file_runner.cpp
...
${OBJECTDIR}/_ext/20fb0c70/parse_curl_nomain.o: ${OBJECTDIR}/_ext/20fb0c70/parse_curl.o ../../../src/dry/parse_cmd/parse_curl.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_curl_nomain.o ../../../src/dry/parse_cmd/parse_curl.cpp;\
	else  \
...
${OBJECTDIR}/_ext/20fb0c70/parse_rsync_nomain.o: ${OBJECTDIR}/_ext/20fb0c70/parse_rsync.o ../../../src/dry/parse_cmd/parse_rsync.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_rsync_nomain.o ../../../src/dry/parse_cmd/parse_rsync.cpp;\
	else  \
...
${OBJECTDIR}/_ext/20fb0c70/parse_wget_nomain.o: ${OBJECTDIR}/_ext/20fb0c70/parse_wget.o ../../../src/dry/parse_cmd/parse_wget.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/20fb0c70/parse_wget_nomain.o ../../../src/dry/parse_cmd/parse_wget.cpp;\
	else  \
...
${OBJECTDIR}/_ext/9c7e2875/read_file_nomain.o: ${OBJECTDIR}/_ext/9c7e2875/read_file.o ../../../src/dry/toolbox/read_file.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9c7e2875/read_file_nomain.o ../../../src/dry/toolbox/read_file.cpp;\
	else  \
...
${OBJECTDIR}/_ext/7bd80be/gzip_file_nomain.o: ${OBJECTDIR}/_ext/7bd80be/gzip_file.o ../../../src/lib/gzip/gzip_file.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7bd80be/gzip_file_nomain.o ../../../src/lib/gzip/gzip_file.cpp;\
	else  \
